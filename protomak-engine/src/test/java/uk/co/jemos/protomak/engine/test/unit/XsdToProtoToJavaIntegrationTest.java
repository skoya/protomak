...
/**
 * Integration tests to confirm that proto files generated by the {@link ConversionService} can be turned into plain java objects.
 * This in effects proves the validity of the proto files.
 * 
 * @author edwilde
 * 
 */
public class XsdToProtoToJavaIntegrationTest {
	...
	public void SimpleSingleElementShouldConvertToAPojo() throws CompilerException {
		...
		String protoFileName = ProtomakEngineHelper.extractProtoFileNameFromXsdName(ProtomakEngineTestConstants.SIMPLE_SINGLE_ELEMENT_FILE_NAME);
		File expectedProtoFile = new File(ProtomakEngineTestConstants.PROTOS_OUTPUT_DIR + File.separatorChar + protoFileName);
